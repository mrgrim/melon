...
namespace melon::nbt
{
    ...
    public:
        ...
        public:
            ...
            tag_access_t<tag_type> &operator*() const requires is_nbt_primitive<tag_type> || is_nbt_container<tag_type> { return operator[](index); };
            ...
            tag_access_t<tag_type> operator*() const requires is_nbt_array<tag_type> { return operator[](index); };

...
int main() {
    ...
    melon::util::gzip_inflate(nbt_data, gz_buffer);
    ...
    std::pmr::memory_resource *pmr_rsrc = new melon::mem::pmr::debug_monotonic_buffer_resource(pmr_buf, 30000);
    ...
    auto pmr_buf = malloc(30000l * 50000l);
    std::pmr::memory_resource *pmr_rsrc = new std::pmr::monotonic_buffer_resource(pmr_buf, 30000l * 50000l);
